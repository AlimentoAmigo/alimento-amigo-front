    ...
    {/* Abaixo da linha verde  */}
     ...
     <div className='w-full bg-green-900 text-white flex justify-center py-2'>
          ...
          <div className="container flex justify-between text-lg">
            <div className="container flex justify-between text-lg">
        <div className="flex justify-left items-center"><img src={favicon} alt="" className='w-30' />
            <div className='text-2xl font-bold uppercase'>Alimento amigo</div></div>
            ...
            <div className='flex px-1 items-center'><div className='px-1'><PlusCircle size={20} /></div><Link to= '/cadastroProduto' className='hover:underline'>Novo Produto</Link></div>
